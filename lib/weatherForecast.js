/**
 * lib/weatherForecast.js
 *
 * This module fetches weather forecast data from Open‑Meteo.
 * It provides functions to fetch both live forecast and historical data.
 *
 * Documentation:
 * - Live Forecast: https://open-meteo.com/en/docs
 * - Historical (Archive) Data: https://open-meteo.com/en/docs/archive-weather-api
 */

// Fetch live forecast data (for future days and today)
