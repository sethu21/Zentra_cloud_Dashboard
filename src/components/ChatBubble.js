...
export default function ChatBubble({ onClose }) {
  const [messages, setMessages] = useState([
    {
      role: "Ai-Farmer assistent",
      content:
        "👋 Hi there!  Ask me anything about your sensor data, plant types, or irrigation needs. Happy to help you.",
    },
  ]);
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <FaRobot size={20} />
          <span style={{ fontWeight: 600 }}>Farm Bot</span>
        </div>
        <button
          onClick={onClose}
          style={{
