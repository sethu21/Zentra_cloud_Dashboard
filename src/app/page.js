...
export default function HomePage() {
  ...
  ];// will be good to make seperate file for this 
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 15 }}>
              Depletion:
               <b>{irrigationDecision.currentDepletion} mm</b>
              <br />
              Threshold: 
              <b>{irrigationDecision.threshold} mm</b>
            </div>
            <button
              style={{
                marginTop: 22,
...
// need to create seperate file for the style this look confusing 